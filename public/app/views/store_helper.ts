...
import {CONSTANT, price_validation, ITEM_TYPES} from "../constant";
...
export class Helper {
    ...
    public ITEM_TYPES: any[] = ITEM_TYPES;
    ...
    public IMPORT_STORE_DATA: any = IMPORT_STORE_DATA;
   	...
   	constructor(public trans: TranslateService, public http: Http,public ngZone:NgZone ,public user_cart: StoreCart,
                public route: ActivatedRoute ,  public  router_id: Router_id, public toastr: ToastsManager ,
                public router: Router,  public elementRef: ElementRef, public data: Data, public tokenService: TokenService) {}
    ...
    car_calling(){
        this.router.navigate(['store/car_calling']);
    }
