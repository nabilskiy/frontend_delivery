...
export class Helper {
    ...
    public PROMO_RECURSION: any = PROMO_RECURSION;
   	...
   	constructor(public trans:TranslateService, public http:Http , public route: ActivatedRoute ,
                public  router_id: Router_id, public toastr: ToastsManager , public router: Router,
                public elementRef:ElementRef, public data: Data, public tokenService: TokenService) {
