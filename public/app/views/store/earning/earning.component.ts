    ...
    export_excel() {
        this.helper.http.post(this.helper.POST_METHOD.GET_STORE_EARNING, {
            ...
            if(res_data.success){
                ...
                var fieldNames  = [this.title.id, this.title.completed_at, this.title.user, this.title.provider,
                ...
                var fields = ['unique_id', 'completed_at', 'user_name', 'provider_name', 'payment_status', 'paid_status',
