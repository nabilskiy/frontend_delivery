...
export interface AddCity {
    ...
    if_not_accepted_call_back_in: Number,
    pre_order_set_request_time: Number, //in minutes
...
export class AddCityComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.add_city = {
            ...
            if_not_accepted_call_back_in: null,
            pre_order_set_request_time: null,
        ...
        // tslint:disable-next-line:one-line
            ...
            this.helper.http.post('/admin/get_city_detail', {city_id: this.city_id}).map((res_data: Response) => res_data.json()).subscribe(res_data => {
                ...
                // tslint:disable-next-line:one-line
                    ...
                    this.add_city.if_not_accepted_call_back_in = res_data.city.if_not_accepted_call_back_in;
                    this.add_city.pre_order_set_request_time = res_data.city.pre_order_set_request_time;
