...
import {PushMarketingComponent} from "./views/admin/push_marketing/push_marketing.component";
...
import {UserOnlineMenuComponent} from "./views/admin/user_online_menu/user_online_menu.component";
...
import {StoreCarCallingComponent} from "./views/store/car_calling/car_calling.component";
...
///// Online menu routes
import {online_menu_basicComponent} from "./common/online_menu/layouts/online_menu_basic.component";
import {MenuComponent} from "./views/online_menu/menu/menu.component";
...
export const ROUTES: Routes = [
    ...
    // App views
    {
        ...
        children: [
            ...
            {path: 'admin/online_menu', component: UserOnlineMenuComponent },
            ...
            {path: 'admin/push_marketing', component: PushMarketingComponent},
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'store/car_calling', component: StoreCarCallingComponent},
    ...
    {
        path: '', component: online_menu_basicComponent,
        children: [
