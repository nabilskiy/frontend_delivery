...
;
import {UserOnlineMenuModule} from "./views/admin/user_online_menu/user_online_menu.module";
...
import {OnlineMenuLayoutsModule} from "./common/online_menu/layouts/online_menu_layouts.module";
import {toreCreateOrderWithoutItemOrderModule} from "./views/store/create_order_without_item/create_order_without_item.module";
import {StoreCarCallingModule} from "./views/store/car_calling/car_calling.module";
...
//OnlineMenu
import {MenuModule} from "./views/online_menu/menu/menu.module";
